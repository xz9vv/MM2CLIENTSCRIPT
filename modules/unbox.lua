...
-- Features: Modular Python-Driven Unboxing, Auto Crate/Key Translation
-- =============================================================================
...
-- Main Unboxing Execution Function
function Unbox.crate(rawCrateName)
    -- Normalize/Look up the crate configuration
    ...
    -- Return the result back to connection.lua so it can respond to Python
